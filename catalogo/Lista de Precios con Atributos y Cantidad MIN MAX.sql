...
if(cl.name='Otras Marcas' or 'Manare_' or a.id_product = 128 or a.id_product = 136 or a.id_product = 137,a.price,Round(a.price * 0.95,0)) AS 'B2B 5% DESCUENTO',
if(cl.name='Otras Marcas'or 'Manare_' or a.id_product = 128 or a.id_product = 136 or a.id_product = 137,a.price,Round(a.price * 0.97,0)) AS 'B2B 3% DESCUENTO',
