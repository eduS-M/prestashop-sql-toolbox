...
a.`active` AS Activo,   
a.date_add, 
(SELECT SUM(total_paid_real / conversion_rate) FROM ps_orders o WHERE o.id_customer = a.id_customer AND o.id_shop IN (1) AND o.valid = 1 and isnull(total_paid_real)) as total_spent, 
...
WHERE 1 AND a.`deleted` = 0 AND a.id_shop IN (1) and a.active = 1
