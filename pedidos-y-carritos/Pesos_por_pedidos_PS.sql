...
left join ps_customer_thread ct on ct.id_order=a.id_order
left join ps_customer_message cm on cm.id_customer_thread = ct.id_customer_thread
...
left join ps_erp_order_merge erp on erp.prst_order_id=a.id_order 
WHERE osl.`name` <> 'Cancelado'
